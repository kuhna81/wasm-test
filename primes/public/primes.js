...
var _isPrime = Module['_isPrime'] = makeInvalidEarlyAccess('_isPrime');
var _checkPrimes = Module['_checkPrimes'] = makeInvalidEarlyAccess('_checkPrimes');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['isPrime'] != 'undefined', 'missing Wasm export: isPrime');
  assert(typeof wasmExports['checkPrimes'] != 'undefined', 'missing Wasm export: checkPrimes');
  ...
  _isPrime = Module['_isPrime'] = createExportWrapper('isPrime', wasmExports['isPrime'], 1);
  _checkPrimes = Module['_checkPrimes'] = createExportWrapper('checkPrimes', wasmExports['checkPrimes'], 1);
